<div class="customer-details">
	...
	<strong><?php esc_html_e( 'Billing Address:', 'wp_subscription' ); ?></strong><br>
	...
	<strong><?php esc_html_e( 'Shipping Address:', 'wp_subscription' ); ?></strong><br>
	...
	<strong><?php esc_html_e( 'Quick Actions:', 'wp_subscription' ); ?></strong><br>
